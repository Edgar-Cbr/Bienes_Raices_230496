...
const registerEmail = async (data) => {
    ...
    await transport.sendMail({
        ...
        text: `Estimado ${name}, es necesario que confirme su cuenta para poder acceder a BienesRaices_230496.`,
        html: `
...
const passwordRecoveryEmail = async (data) => {
    ...
    await transport.sendMail({
        ...
        text: `Estimado ${name}, haz solicitado el cambio de contraseña de tu cuenta en BienesRaices_230496.`,
        html: `
            <header style="font-family: bold; text-align: center; line-height: 0.5;">
                <h2>Bienes Raices</h2>
